...
public class TaskTest {
    ...
    void equalsToEachOtherIfEqualsId() {
        Task task1 = new Task("first_task", "non desc", Status.NEW, 30,
                "2025-08-01 10:00:00");
        Task task2 = new Task("second_task", "non desc", Status.NEW, 45,
                "2025-08-01 12:00:00");
    ...
    void manualAndAutoGeneratedIdsDoNotConflict() {
        Task taskAuto = new Task("first_task", "non desc", Status.NEW, 30,
                "2025-08-01 10:00:00");
        Task taskManual = new Task("second_task", "non desc", Status.NEW, 45,
                "2025-08-01 12:00:00");
    ...
    void checkImmutabilityAllFieldsTasks() {
        Task taskInit = new Task("first_task", "non desc", Status.NEW, 30,
                "2025-08-01 10:00:00");
